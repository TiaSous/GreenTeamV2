...
app.get("/", (req, res) => {
  res.send(`<a href='${process.env.APP_HOST}/arroseur/on'>Turn on the light</a>  ||  <a href='${process.env.APP_HOST}/arroseur/off'>Turn off the light</a>`);
});

app.get("/arroseur/on", (req, res) => {
  client.publish("arroseur", ConvertToJson({ status: "start" }));
  res.send(`The light is on </br> <a href='${process.env.APP_HOST}/arroseur/off'>Turn off the light</a>`);

});

app.get("/arroseur/off", (req, res) => {
  client.publish("arroseur", ConvertToJson({ status: "end" }));
  res.send(`The light is off </br> <a href='${process.env.APP_HOST}/arroseur/on'>Turn on the light</a>`);
